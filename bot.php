...
// Bot criado por @MasteNetR_M código original para o @MasteNetR_M
...
switch ($tlg->Text ()){
	...
	$tlg->sendMessage ([
		...
		'reply_markup' => $tlg->buildInlineKeyBoard ([
			[$tlg->buildInlineKeyboardButton ('🇧🇷 SSH Teste BR 🇧🇷', null, '/teste')]
		])
	]);
	...
	$tlg->sendMessage ([
		'chat_id' => $tlg->ChatID (),
		'text' => 'Bot original @MasteNetR_M por @MasteNetR_M'
	]);
